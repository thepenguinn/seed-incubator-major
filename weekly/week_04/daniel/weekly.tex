...
The vertical panels for the incubator area including front panel, back panel,
front side panels, back side panel and back side hatch were built. See figure
\ref{fig:partsOfIncArea} for the different assembled parts. Figure
\ref{fig:partsOfIncAreaCAD} depicts all the parts that are currently built.
