...
\newcommand\tblDrawTop[0] {
    ...
    node [
        above = \tblTopPad,
        anchor = south,
    ] {\color{colorP1Dark}\texttt{ANJANA}}
    ...
    node [
        above = \tblTopPad,
        anchor = south,
    ] {\color{colorP2Dark}\texttt{ASWATHEERTHA}}
    ...
    node [
        above = \tblTopPad,
        anchor = south,
    ] {\color{colorP3Dark}\texttt{ATHIRA}}
    ...
    node [
        above = \tblTopPad,
        anchor = south,
    ] {\color{colorP4Dark}\texttt{DANIEL}}

    ;

    \draw
    (previtmp) coordinate (itmp)
    ;
}
